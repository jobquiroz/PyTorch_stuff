...
import importlib     # Provides the implementation of 'import'
                     # The componentes to implement import are exposed, making it easier for users to create 
...
# Solution for importing folders as packages in windows...
import os, sys
